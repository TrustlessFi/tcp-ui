...
export default function PositionListItem({ positionDetails }: PositionListItemProps) {
  ...
  const pool = useMemo(() => {
    ...
    return new Pool(token0 as Token, token1 as Token, feeAmount, JSBI.BigInt(slot0.sqrtPriceX96), JSBI.BigInt(liquidity), slot0.tick);
  ...
  const positionSummaryLink = '/liquidity/position/' + positionDetails.tokenId
