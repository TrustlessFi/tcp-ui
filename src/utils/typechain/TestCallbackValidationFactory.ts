...
import { TestCallbackValidation } from "./TestCallbackValidation";

export class TestCallbackValidationFactory extends ContractFactory {
  ...
  connect(signer: Signer): TestCallbackValidationFactory {
    return super.connect(signer) as TestCallbackValidationFactory;
  }
  static connect(
    address: string,
