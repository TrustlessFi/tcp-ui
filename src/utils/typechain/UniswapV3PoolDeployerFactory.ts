...
import { UniswapV3PoolDeployer } from "./UniswapV3PoolDeployer";

export class UniswapV3PoolDeployerFactory extends ContractFactory {
  ...
  connect(signer: Signer): UniswapV3PoolDeployerFactory {
    return super.connect(signer) as UniswapV3PoolDeployerFactory;
  }
  static connect(
    address: string,
