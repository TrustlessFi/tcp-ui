...
interface TcpMulticallViewOnlyInterface extends ethers.utils.Interface {
  functions: {
...
export class TcpMulticallViewOnly extends BaseContract {
  ...
  interface: TcpMulticallViewOnlyInterface;
